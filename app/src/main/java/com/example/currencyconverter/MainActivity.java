...
public class MainActivity<RequestQueue> extends AppCompatActivity {
    ...
    TextView convertFromDropdownTextView,convertToDropdownTextView,conversationRateText;
    ...
    String[] country={"AFN","EUR","INR","USD","BSD","AUD","JPY","BDT","BBD"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convertFromDropdownTextView=findViewById(R.id.convert_from_dropdown);
        convertToDropdownTextView=findViewById(R.id.convert_to_dropdown);
        convertButton=findViewById(R.id.conversionButton);
        conversationRateText=findViewById(R.id.conversionRateText);
        ...
        convertToDropdownTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDialog.getWindow().setLayout(550,800);
                toDialog.show();
    ...
    private String getConversionRate(String convertFromValue, String convertToValue, Double amountToConvert) {
        ...
        String url= "https://free.currconv.com/api/v7/convert?q="+convertFromValue+"_"+convertToValue+"&compact=ultra&apiKey=0974bb6c76a6fc20e394";
        StringRequest stringRequest= new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    conversationRateText.setText(conversionValue);
